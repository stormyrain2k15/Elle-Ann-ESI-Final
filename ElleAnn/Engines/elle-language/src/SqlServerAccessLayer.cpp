// ============================================================================
// Elle Engine -- SqlServerAccessLayer implementation
// File: src/SqlServerAccessLayer.cpp
//
// All queries are parameterized via SQLBindParameter. Every method holds the
// per-instance mutex for the duration of the call (one outstanding statement
// per ODBC connection is the safe contract).
// ============================================================================
