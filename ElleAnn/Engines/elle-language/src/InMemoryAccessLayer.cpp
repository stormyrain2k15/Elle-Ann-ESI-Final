// ============================================================================
// Elle Engine -- In-memory access layer
// File: src/InMemoryAccessLayer.cpp
//
// Fixture-backed implementation of ISqlAccessLayer used by tests and demos.
// The data here is the EXACT integer-indexed mirror of sql/02_*..07_*.sql.
// Any change to the SQL seed MUST be reflected here and vice versa.
// ============================================================================
...
public:
    ...
    std::vector<PhraseRecord> findPhrasesStartingWith(WordID firstWord, int maxWordCount) override {
        ...
        // Longer phrases first (longest-match-first scan).
    ...
    std::int64_t persistAnalysisTrace(const std::string&, const std::string&,
        ...
        return 0;  // not supported in-memory
    }
