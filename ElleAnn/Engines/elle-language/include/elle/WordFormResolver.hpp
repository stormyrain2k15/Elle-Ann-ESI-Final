// ============================================================================
// Elle Engine -- Word / Form Resolver
// File: include/elle/WordFormResolver.hpp
//
// Single-word lookup with a strict fallback ladder:
//   1. exact WordID by normalized lemma
//   2. WordFormID by normalized form (inflections, contractions)
//   3. unknown-word handler (records but does not fail)
// ============================================================================
#pragma once
...
struct ResolvedWord {
    ...
    std::string               surface;       // original lexeme normalized form
};
