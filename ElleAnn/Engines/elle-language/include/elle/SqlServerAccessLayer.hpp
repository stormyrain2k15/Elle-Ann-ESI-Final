// ============================================================================
// Elle Engine -- SQL Server (ODBC) access layer
// File: include/elle/SqlServerAccessLayer.hpp
// ============================================================================
#pragma once
...
// Production ISqlAccessLayer backed by an ODBC connection. Thread-safe via a
// single mutex around the connection. For high-concurrency deployments,
// hold one SqlServerAccessLayer per worker thread.
