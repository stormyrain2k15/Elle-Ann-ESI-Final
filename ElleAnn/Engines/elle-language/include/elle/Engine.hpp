// ============================================================================
// Elle Engine -- Engine facade
// File: include/elle/Engine.hpp
//
// Orchestrates the 10 layers in order. Owns no DB connection itself; takes a
// shared ISqlAccessLayer. Re-entrant; one Engine instance can analyze many
// inputs from many threads (each layer's caches are mutex-guarded).
// ============================================================================
#pragma once
...
public:
    ...
    // Optionally persist the result. Returns the AnalysisTraceID or 0.
