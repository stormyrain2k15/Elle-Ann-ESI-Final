// ============================================================================
// Elle Probability Engine -- Distribution tests
// File: tests/test_distribution.cpp
// ============================================================================
...
TEST_CASE("Distribution: entropy is log2(n) for uniform over n") {
    ...
    d.mass[3] = 0.25;
    d.mass[4] = 0.25;
    CHECK(d.entropy() == doctest::Approx(2.0).epsilon(1e-9));  // log2(4)
}
...
TEST_CASE("Distribution: sample is deterministic at boundaries") {
    ...
    d.mass[2] = 0.5;
    d.normalize();
    // u=0 should return the first entry that accumulates past 0.
    // u=0.99 should return the last.
